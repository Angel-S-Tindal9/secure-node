...
document.addEventListener('DOMContentLoaded', () => {
    ...
    scannerTrigger.addEventListener('click', () => {
        if(!isScannerUnlocked) {
            ...
            alert("El escáner está en verde. La puerta principal está libre.");
        }
    });
    ...
    function checkWinCondition() {
        if (piecesPlaced === totalPieces) {
            ...
            setTimeout(() => {
                ...
                alert("¡El escáner validó la tarjeta! La puerta de escape final está abierta.");
            }, 1500);
        }
    }
    ...
    doorEscape.addEventListener('click', () => {
        if (isScannerUnlocked) {
            ...
            alert("Acceso denegado. Reconstruye la tarjeta maestra en el escáner.");
        }
    });
    ...
    document.querySelector('.radio-oculta').addEventListener('click', (e) => {
        radioClicks++;
        if (radioClicks === 5) {
            alert("La radio emite estática y una secuencia: RAYA PUNTO RAYA ( -.- )");
